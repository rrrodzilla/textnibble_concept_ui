...
class LiveOrdersScreen(Screen):
    ...
    def go_to_order_detail_screen(self, order_obj):
        self.manager.edit_order(order_obj)
        # self.manager.order_manager.current_order = order_obj
    ...
    def on_orders(self, instance, value):
        ...
        for order_obj in _orders:
            ...
            order_widget.bind(on_press=(lambda x: self.go_to_order_detail_screen(order_obj)))
